        ...
        <div className="container-fluid p-2 p-md-4 overflow-hidden" style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
            ...
            <div className="row g-3 mb-4">
                <div className="col-12 col-sm-6 col-xl-3">
                    <MiniStatsCard title="Invoiced" amount={`$${stats.contract_total || '0.00'}`} subtext="Total Contracts" color={QB_COLORS.blue} chartType="bar" />
                </div>
                <div className="col-12 col-sm-6 col-xl-3">
                    <MiniStatsCard title="Received" amount={`$${stats.total_collected || '0.00'}`} subtext="Collected Amount" color={QB_COLORS.green} chartType="area" />
                </div>
                <div className="col-12 col-sm-6 col-xl-3">
                    <MiniStatsCard title="Outstanding" amount={`$${stats.remaining_balance || '0.00'}`} subtext="Pending Balance" color={QB_COLORS.red} chartType="bar" />
                </div>
                <div className="col-12 col-sm-6 col-xl-3">
                    <MiniStatsCard title="Collection Rate" amount={`${stats.collected_percentage || 0}%`} subtext="Success Margin" color={QB_COLORS.dark} chartType="area" />
                </div>
            </div>
            ...
            <div className="row g-3 mb-4">
                <div className="col-12 col-md-6 col-lg-4">
                    <DataDonut title="Lead Sources" totalTitle="Total Leads" totalValue={totalLeads} data={leadData} />
                </div>
                <div className="col-12 col-md-6 col-lg-4">
                    <DataDonut title="Work Order Stages" totalTitle="Active Jobs" totalValue={totalWO} data={workOrderData} />
                </div>
                        ...
                        {dashboardData?.topProducts?.map((product, i) => (
                            <div key={i} className="mb-3">
                                ...
                                <div className="progress" style={{ height: '8px' }}>
                                    <div className="progress-bar rounded-pill" style={{ width: `${Math.min(100, (product.sales || 0) * 10)}%`, backgroundColor: QB_COLORS.blue }}></div>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="card border-0 shadow-sm bg-white" style={{ borderRadius: '12px' }}>
                        <div className="card-body p-2 p-md-4">
                            <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                                ...
                                <span className="badge px-3 py-2" style={{ backgroundColor: '#e3f2fd', color: '#0d6efd' }}>
                                    ...
                                    <tbody>
                                        {appointments.length > 0 ? appointments.map((app, i) => (
                                            <tr key={i} className="border-bottom-0">
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-xs me-2 d-flex align-items-center justify-content-center rounded-circle text-info fw-bold flex-shrink-0" 
                                                ...
                                                <td>
                                                    <span className="badge rounded-pill" 
                                                          style={{ padding: '4px 8px', fontSize: '9px', fontWeight: '600', letterSpacing: '0.3px', 
                                                                   ...
                                                                   color: app.type === 'site_visit' ? '#0288d1' : '#3f51b5' }}>
            ...
            <div className="row g-3">
                <div className="col-12 col-lg-7">
                    <div className="card border shadow-sm bg-white h-100">
                        <div className="card-body p-3">
                            <h6 className="text-muted small fw-bold text-uppercase mb-3">Recent Invoices (DUE)</h6>
                ...
                <div className="col-12 col-lg-5">
                    <div className="card border shadow-sm bg-white h-100">
                        <div className="card-body p-3">
                            <h6 className="text-muted small fw-bold text-uppercase mb-3">Latest Purchase Orders</h6>
                                    ...
                                    dashboardData.latestPO.map((po, i) => (
                                        <div key={i} className="d-flex justify-content-between align-items-center mb-2 border-bottom pb-2">
                                            ...
                                            <div className="text-end flex-shrink-0">
                                                ...
                                                <span className={`badge ${po.payment_status === 'PENDING' ? 'bg-warning text-dark' : 'bg-danger text-white'}`} 
