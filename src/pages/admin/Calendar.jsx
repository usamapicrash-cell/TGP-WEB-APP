        ...
        try {
            ...
            const mappedEvents = response.data.map(visit => ({
                ...
                extendedProps: {
                    ...
                    leadId: visit.lead?.lead_number || visit.lead?.gjob?.job_number || 'N/A',
        ...
        <div className="p-3 bg-light min-vh-100">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <button 
                    ...
                    style={{ backgroundColor: '#2b3a67', border: 'none', borderRadius: '8px' }}
                    onClick={() => setShowModal(true)}
                >
                    <i className="bi bi-plus-lg"></i> <span className="d-none d-sm-inline">Schedule</span>
                </button>
            </div>
